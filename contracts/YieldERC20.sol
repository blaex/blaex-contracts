...
import "./interfaces/IYieldERC20.sol";

contract YieldERC20 is IYieldERC20, IERC20, Pausable {
    /**
     * @dev YieldERC20 balances are dynamic and are calculated based on the accounts' shares
